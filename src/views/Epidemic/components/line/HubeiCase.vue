...
export default {
  ...
  methods: {
    initChart () {
      this.hubeiCaseChart = echarts.init(document.getElementById(this.id))
      this.hubeiCaseChart.showLoading()
      switch (this.type) {
        case '1':
          this.hubeiCaseChart.setOption(this.option1)
          break
        case '2':
          this.hubeiCaseChart.setOption(this.option2)
          break
        case '3':
          this.hubeiCaseChart.setOption(this.option3)
          break
        case '4':
          this.hubeiCaseChart.setOption(this.option4)
          break
      }
      var _this = this
      this.$http.get('hubeiCase').then(resp => {
      ...
      this.hubeiCaseChart.hideLoading() // 隐藏 loading 效果
    }
  }
}
</script>
